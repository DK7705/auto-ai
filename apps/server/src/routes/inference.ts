...
/**
 * Execute Python inference script using uv
 */
async function executePythonInference(
  ...
  try {
    // Create a temporary file for input data to avoid command-line escaping issues
    ...
    try {
      // Use uv to run the Python script with required dependencies
